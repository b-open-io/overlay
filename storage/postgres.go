...
func (s *PostgresTopicDataStorage) InsertOutputs(ctx context.Context, txid *chainhash.Hash, outputs []uint32, outpointsConsumed []*transaction.Outpoint, beef []byte, ancillaryTxids []*chainhash.Hash) error {
	if len(outputs) == 0 {
		return nil
	}
